...
const NavBr = () => {
  ...
  return (
    <nav className={`z-30 absolute top-1 pt-3 w-full  pb-3  ${ isHomePage || isProductDetails ? "shadow-none" : "shadow-md shadow-[#e2e7e0]"} `}>
      <div className="">
            ...
            <div className="flex items-center">
              <div className="hidden md:flex">
                <div className="flex items-baseline space-x-4">
                  ...
                  <NavLink to='/checkout' className="relative text-black hover:text-[#59a83d] px-3 py-2 rounded-md text-sm font-medium">
                      <div className="flex">
                    ...
                    <span className=" relative">
                      ...
                      <span className="absolute -top-4 right-0 bg-[#97d384] text-white px-1 rounded-full">{`${totalQuantity >= 10 ? "9+" :`${data?.data?.length}`}`}</span>
                    </span>
