...
const Products = () => {
  ...
  return (
    <div className="pb-20 sm:pt-24 pt-44 sm:px-6 lg:px-[60px]   bg-gradient-to-bl from-[#97d384] to-[#e8ebe79d] min-h-[85vh]">
      <div className="py-5 px-2 mx-6 flex flex-col xl:flex-row justify-between items-center border rounded-lg">
        <div className="lg:text-2xl font-semibold text-gray-700 flex justify-center items-center gap-4">
          <span>Explore Our Full Range of Products</span>
          <span>
            <svg
